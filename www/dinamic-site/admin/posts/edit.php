    ...
    <div class="posts col-9">
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col mb-4">
                    <input value="<?=$post['title']; ?>" name="title" type="text" class="form-control" placeholder="Title" aria-label="Article title">
                </div>
                <div class="col">
                ...
                <div class="col col-6">
                    <button name="edit_post" class="btn btn-primary" type="submit">Save entry</button>
                </div>
            </form>
        </div>
