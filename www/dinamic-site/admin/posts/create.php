...
<div class="container">
    <?php include "../../app/include/sidebar-admin.php"; ?>  
        ...
        <div class="button row">
                ...
                <a href="<?php echo BASE_URL . "admin/posts/index.php";?>" class="col-2 btn btn-warning">Edit</a>
            </div>
            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    <div class="col mb-4"> 
                        <input value="<?=$title; ?>" name="title" type="text" class="form-control" placeholder="Title" aria-label="Article title">
                    </div> 
                    <div class="col">
                    ...
                    <select name="topic" class="form-select mb-2" aria-label="Default select example">
                            <option selected>Category post:</option>
                    ...
                    <div class="form-check">
                      ...
                      <div class="col col-6">
                        <button name="add_post" class="btn btn-primary" type="submit">Add entry</button>
                    </div>
                </form>
            </div>
        </div>
