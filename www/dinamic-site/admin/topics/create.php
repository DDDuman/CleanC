    ...
    <?php include "../../app/include/sidebar-admin.php"; ?>  
        ...
        <div class="posts col-9">
            <div class="button row">
                ...
                <a href="<?php echo BASE_URL . "admin/topics/index.php";?>" class="col-2 btn btn-warning">Edit</a>
            </div>
            ...
            <div class="mb-12 col-12 col-md-12 err">
                ...
                <form action="create.php" method="post">
                    <div class="col"> 
                        <input name="name" value="<?=$name;?>" type="text" class="form-control" placeholder="Name of category" aria-label="Name of category">
                    </div> 
                    <div class="col">
