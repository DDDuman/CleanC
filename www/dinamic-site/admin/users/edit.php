        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col">
                    ...
                    <input name="mail" value="<?=$email;?>" type="email" class="form-control" readonly id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter your email...">
                </div>
                <div class="col">
                    <label for="exampleInputPassword1" class="form-label">Reset the password</label>
                ...
                <div class="col">
                    <button name="update-user" class="btn btn-primary" type="submit">Refresh</button>
                </div>
            </form>
        </div>
